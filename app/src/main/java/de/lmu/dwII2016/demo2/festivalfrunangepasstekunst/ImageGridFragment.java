...
public class ImageGridFragment extends Fragment implements AdapterView.OnItemClickListener {
   ...
   public void onCreate(Bundle savedInstanceState) {
      ...
      mAdapter = new ImageAdapter(getActivity(), werkeArray, kuenstlerArray);
   ...
   private class ImageAdapter extends BaseAdapter {
      ...
      public ImageAdapter(Context context, List<Integer> werkeArray, List<String> kuenstlerArray) {
         super();
         mContext = context;
         this.images = werkeArray;
         this.kuenstlerNames = kuenstlerArray;
